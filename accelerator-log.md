...
```json
{
  "apiDescription" : "We will figure this out",
  "apiOwner" : "unicorn",
  "apiSystem" : "unicorn",
  "artifactId" : "customer-profile",
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=Mpluya&repo=java-rest-service",
  "buildTool" : "maven",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#exposeOpenAPIEndpoint) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [DESCRIPTION_VAL->We will figure this ...(truncated), OWNER_VAL->unicorn, SYSTEM_VAL->unicorn]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=Mpluya&repo=java-rest-service'
